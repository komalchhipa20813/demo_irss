...
<div class="modal fade select  bd-example-modal-md" id="companyBranch_modal" tabindex="-1" aria-labelledby="title_companyBranch_modal" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="title_company_branch_modal">Add Company Branch </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
        </div>
        <div class="modal-body">
          <form class="forms-sample" method="POST" enctype="multipart/form-data" id="company_branch_form">
            @csrf
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                @if($company->isEmpty())
                    <option selected disabled value="0">First Enter Company Name</option>
                @else
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control " id="company_branch_name" value="" name="company_branch_name" placeholder="Enter Company Branch Name">
            </div>
            <div class="mb-3">
              <label>Address</label>
              <textarea class="form-control" id="address" placeholder="Enter  Address" name="address" rows="5" value=""></textarea>
            </div>
            <button class="btn btn-primary submit_companyBranch" type="button"></button>
          </form>
        </div>
      </div>
    </div>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <div class="row">
              <h6 class="card-title col">Company Branches</h6>
              <div class="col-2 ">
                @if(in_array("22", permission()))
                    <a  class="btn btn-primary add_companyBranch" data-id="{{ encryptid('0') }}" style="float: right" id="add_companyBranch">Add Company Branch</a>
                @endif
              </div>
            </div>
          <div class="table-responsive mt-2">
            <table id="company-branch_tbl" class="table">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Company Name</th>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/companyBranch/company_branch.js') }}"></script>
