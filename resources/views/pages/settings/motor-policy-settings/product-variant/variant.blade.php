...
<!-- Make Modal -->
<div class="modal fade select  bd-example-modal-md" id="variant_modal" tabindex="-1" aria-labelledby="title_variant_modal" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="title_variant_modal">Add Variant </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
        </div>
        <div class="modal-body">
          <form class="forms-sample" method="POST" enctype="multipart/form-data" id="variant_form">
            @csrf
            ...
            <div class="mb-3">
              ...
              <select class=" form-select model_id" id="model_id" data-width="100%" name="model_id" >
                 <option value="0" selected disabled>First select Product Make</option>
            ...
            <button class="btn btn-primary submit_variant" type="button"></button>
          </form>
        </div>
      </div>
    </div>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <div class="row">
              <h6 class="card-title col">Variants</h6>
              <div class="col-2 ">
                @if(in_array("94", permission()))
                    <a  class="btn btn-primary add_variant" data-id="{{ encryptid('0') }}" style="float: right" id="add_variant">Add Variant</a>
                @endif
              </div>
            </div>
          <div class="table-responsive mt-2">
            <table id="product-variant_tbl" class="table" style="width: 98% !important;">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Product</th>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/product-variant/variant.js') }}"></script>
