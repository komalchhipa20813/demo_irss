...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Update Motor Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <select class="form-select form-control select_dropdown" id="agent" name="  " placeholder="Select agent">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" name="engine_no" id="engine_no" value="" autocomplete="off" placeholder="Enter Engine No">
            </div>
            <div class="col-md-3 mb-3">
                <label for="chasis_no" class="control-label">Chasis No</label>
                <input type="text" class="form-control" name="chasis_no" id="chasis_no" value="" autocomplete="off" placeholder="Enter Chasis No">
            </div>
            <div class="col-md-3 mb-3">
                <label for="registration_no" class="control-label">Registration No</label>
                <input type="text" class="form-control" name="registration_no" id="registration_no" value="" autocomplete="off" placeholder="Enter Registration No">
            </div>
            <div class="col-md-3 mb-3">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control datepicker" name="start_date" id="start_date" value="" autocomplete="off" placeholder="Enter From Date">
            </div>
            <div class="col-md-3 mb-3">
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
              <button  class="btn btn-primary filter_policy" id="filter_policy">Filter Motor Policy</button>
          </div>
          <div class="col-2" style="width: auto">
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <div class="row">
            <h6 class="card-title col">Update Motor Policies</h6>
            <div class="col-2 " style="width: auto">
               <button type="button" id="export" style="float: right" class="btn btn-primary me-2s"> Export Motor Policy</button>
               <input type="hidden" name="module" value="motor" class="module">
            </div>
          </div>
        <div class="table-responsive mt-2">
          <form class="forms-sample motor_policy-update-form" method="POST" name="registration" id="policy_updation_form" enctype="multipart/form-data">
            @csrf
          <table id="update-policy_tbl" class="table" data-name="motor" style="width: 98%!important;" >
            <thead>
              <tr>
              	<th width="10px"><input type="checkbox" name="select_all" id="select_all"
                                    class="styled checkbox_head" onclick="select_all_policy(this);"></th>
                <th width="20px">Branch Imd Name</th>
                <th>Customer Name</th>
                <th>Inward No/Company/AgentCode</th>
                <th>Product</th>
                <th>OD & TP</th>
                <th>Total</th>
                <th>Issue Date</th>
...
<script src="{{ asset('assets/js/policies/update-policy.js') }}"></script>
