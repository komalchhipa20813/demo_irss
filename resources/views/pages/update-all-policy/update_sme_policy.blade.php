...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Update SME Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
              <button  class="btn btn-primary filter_policy" id="filter_policy">Filter SME Policy</button>
          </div>
          <div class="col-2" style="width: auto">
      ...
      <div class="card-body">
          <div class="row">
           ...
           <div class="col-2 " style="width: auto">
               ...
               <input type="hidden" name="module" value="sme" class="module">
            </div>
          </div>
       ...
       <form class="forms-sample policy-update-form" method="POST" name="registration" id="policy_updation_form" enctype="multipart/form-data">
       	@csrf
          <table id="update-policy_tbl" class="table" data-name="sme" style="width: 95%!important;">
            <thead>
              <tr>
                <th width="10px">
