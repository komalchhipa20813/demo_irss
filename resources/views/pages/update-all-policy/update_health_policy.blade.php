...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Update Health Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
              <button  class="btn btn-primary filter_policy" id="filter_policy">Filter Health Policy</button>
          </div>
          <div class="col-2" style="width: auto">
