...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Health Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
            <button  class="btn btn-primary filter_health_policy" id="filter_health_policy">Filter Health Policy</button>
          </div>
          <div class="col-2" style="width: auto">
...
<div class="row">
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <div class="row">
            <h6 class="card-title col">Health policies</h6>
            <div class="col-2 " style="width: auto">
              @if(isset(Auth::user()->id)&&in_array("126", $permissionList))
                <a href="" class="btn btn-primary sync_policy" data-policy="health" style="float: right" id="sync_policy">Sync Health Policy</a>
              @endif
            </div>
            <div class="col-2" style="width: auto">
              @if(isset(Auth::user()->id)&&in_array("102", $permissionList))
                <a href="{{ route('health-policy.create') }}" class="btn btn-primary add_health_policy" data-id="{{ encryptid('0') }}" style="float: right" id="add_health_policy">Add Health Policy</a>
              @endif
            </div>
            <div class="col-2 exportBtn" style="width: auto">
                 <button type="button" id="export" style="float: right" class="btn btn-primary me-2s"> Export Health Policy</button>
            </div>
            <!-- <div class="col-2 " style="width: auto">
              <a class="btn btn-primary" style="float: right" href="{{ route('export-health-policy') }}">Export Health Policy</a>
            </div> -->
          </div>
        <div class="table-responsive mt-2">
          <table id="health-policy_tbl" class="table" style="width: 98% !important;">
            <thead>
              <tr>
                <th>Policy Number</th>
                <th>Main Product</th>
