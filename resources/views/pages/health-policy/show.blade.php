...
@endphp
@extends($master)
@section('title', 'Show Health Policy')
@push('style')
    <style>
        .control-label {
            font-weight: 500;
...
@section('content')
    <nav class="page-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ isset(Auth::user()->id) ? route('health-policy.index') : route('fdo-agent.health-policy.index') }}">Health Policy</a></li>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin policy-grid-margin">
            <div class="card">
                <div class="card-body">
                    <div><h5 class="card-title">HEALTH - {{$getPolicy->inward_no}} - {{$getPolicy->branch->name}}- {{$getPolicy->business_date}} </h5></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <span>{{ isset($getPolicy->product_type) ? (($getPolicy->product_type == 0) ? 'Individual' : 'Floater') : '-'}}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Main Product</label>
                            <span>{{ 'HEALTH' .' - '.  (isset($getPolicy->product_id) ? $getPolicy->product->name :'') .''.
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <span>{{ isset($getPolicy->company_branch->name) ? $getPolicy->company_branch->name : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Policy Number</label>
                            <span>
                            @if($getPolicy->policy_type == 'renewal' || $getPolicy->policy_type == 'port renewal')
        ...
        <div class="col-md-12 grid-margin policy-grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Proposal DOB</label>
                            <span>{{ isset($getPolicy->proposal_dob) ? $getPolicy->proposal_dob : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Sum Insured</label>
                            <span>{{ isset($getPolicy->sum_insured) ? $getPolicy->sum_insured : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
