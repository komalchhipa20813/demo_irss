...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Motor Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
            ...
            <div class="col-md-3 mb-3">
                <label for="branch" class="control-label">Retinue Branch</label>
                    <select class="form-select form-control " id="branch" name="branch" placeholder="Select Branch">
                        ...
                        <option @if (1 == $branch->id) selected @endif value="{{ $branch->id}}" selected>{{ ucfirst($branch->name)}}</option>
                        @endforeach
                        @else
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
              <button  class="btn btn-primary filter_motor_policy" id="filter_motor_policy">Filter Motor Policy</button>
          </div>
          <div class="col-2" style="width: auto">
...
<div class="row">
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <div class="row">
            <h6 class="card-title col">Motor Policies</h6>
              <div class="col-2 " style="width: auto">
                @if(isset(Auth::user()->id)&&in_array("126", $permissionList))
                  <a href="" class="btn btn-primary sync_policy" data-policy="motor" style="float: right" id="sync_policy">Sync Motor Policy</a>
                @endif
              </div>
              <div class="col-2 " style="width: auto">
                @if(isset(Auth::user()->id)&&in_array("110", $permissionList))
                  <a href="{{ route('motor-policy.create') }}" class="btn btn-primary add_motor_policy" data-id="{{ encryptid('0') }}" style="float: right" id="add_motor_policy">Add Motor Policy</a>
                @endif
              </div>
              ...
              <div class="col-2 " style="width: auto">
                  <a href="{{ route('motor-policy.download-pdf') }}" class="btn btn-primary "  style="float: right" id="download_motor_policy">Download Policy</a>
             
              </div>
          </div>
        <div class="table-responsive mt-2">
          <table id="motor-policy_tbl" class="table" style="width: 98% !important;">
            <thead>
              <tr>
                <th>Policy Number</th>
