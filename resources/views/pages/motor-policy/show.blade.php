...
@endphp
@extends($master)
@section('title', 'Show Motor Policy')
@push('style')
    <style>
        .control-label {
            font-weight: 500;
...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ isset(Auth::user()->id) ? route('motor-policy.index') : route('fdo-agent.motor-policy.index') }}">Motor
                    Policy</a></li>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin policy-grid-margin">
            <div class="card">
                <div class="card-body">
                    <div><h5 class="card-title">MOTOR - {{$getPolicy->inward_no}} - {{$getPolicy->branch->name}}- {{$getPolicy->business_date}} </h5></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <span>{{ 'MOTOR' .' - '. $getPolicy->product->name .' - '. $getPolicy->sub_product->name}}</span>
                        </div>
                        <div class="col-md-3 mb-3">
        ...
        <div class="col-md-12 grid-margin policy-grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Registration No.</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->registration_no) ? $getPolicy->motor_policy_vehicle->registration_no : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">RTO Code</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->city_id) ? $getPolicy->motor_policy_vehicle->rto_city->rto_code  : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">RTO City</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->city_id) ? $getPolicy->motor_policy_vehicle->rto_city->name  : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Engine No.</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->engine_no) ? $getPolicy->motor_policy_vehicle->engine_no : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Chasiss No. </label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->chasiss_no) ? $getPolicy->motor_policy_vehicle->chasiss_no : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Make </label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->make_id) ? $getPolicy->motor_policy_vehicle->make->name : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Model</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->model_id) ? $getPolicy->motor_policy_vehicle->product_model->name : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Variant</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->variant_id) ? $getPolicy->motor_policy_vehicle->product_variant->name : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">CC / GVW </label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->cc_gvw_no) ? $getPolicy->motor_policy_vehicle->cc_gvw_no : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Manufacturing Year</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->manufacturing_year) ? $getPolicy->motor_policy_vehicle->manufacturing_year : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Seating Capacity</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->seating_capacity) ? $getPolicy->motor_policy_vehicle->seating_capacity : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Fuel Type</label>
                            <span>{{ isset($getPolicy->motor_policy_vehicle->fuel_type) ? $getPolicy->motor_policy_vehicle->fuel_type : '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 grid-margin policy-grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row show-data">
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">IDV</label>
                            <span>{{ isset($getPolicy->total_idv) ? $getPolicy->total_idv : '-' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Discount</label>
                            <span>{{ isset($getPolicy->discount) ? $getPolicy->discount : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">NCB</label>
                            <span>{{ isset($getPolicy->ncb) ? $getPolicy->ncb : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">ADD ON</label>
                            <span>{{ isset($getPolicy->addonpremium) ? $getPolicy->addonpremium : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Total OD</label>
                            <span>{{ isset($getPolicy) ? $data['total_od'] : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">TP</label>
                            <span>{{ isset($getPolicy->tp) ? $getPolicy->tp : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">CPA Cover</label>
                            <span>{{ isset($getPolicy->pay_to_owner) ? $getPolicy->pay_to_owner : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">TP Premium</label>
                            <span>{{ isset($getPolicy) ? $data['total_tp_or_ter'] : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="product" class="control-label">Net Premium</label>
                            <span>{{ isset($getPolicy) ? $data['net_premium'] : '0' }}</span>
                        </div>
                        <div class="col-md-3 mb-3">
