...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">FDO Details</li>
  </ol>
</nav>
<div class="row">
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <div class="row">
            <h6 class="card-title col">FDO Details</h6>
          </div>
          <form class="forms-sample fdo-detail-form" method="POST" name="fdo_detail" id="fdo_detail" >
            @csrf
          <div class="row">
          ...
          <div class="col-md-3 mb-3">
           ...
           <div class="col-sm-2">
               <button class="btn btn-primary submit_fdo_detail" type="button">Export</button>
            </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/reports/fdo-details/fdo-details.js') }}"></script>
