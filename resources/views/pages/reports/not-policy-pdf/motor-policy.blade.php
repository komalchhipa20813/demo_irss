...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Not upload Motor Policy</li>
  </ol>
</nav>
...
<div class="row">
    ...
    <div class="col-md-12 grid-margin stretch-card mb-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <h6 class="card-title col">Not upload Motor Policies</h6>
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive mt-2">
          <table id="not-uploaded-policy_tbl" class="table" >
            <thead>
              <tr>
                <th>Policy Number</th>
...
<script src="{{ asset('assets/js/reports/not-policy-pdf/motor-pdf-policy.js') }}"></script>
