...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Not upload Health Policy</li>
  </ol>
</nav>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-2" style="width: auto">
            <button  class="btn btn-primary filter_health_policy" id="filter_policy">Filter Health Policy</button>
          </div>
          <div class="col-2" style="width: auto">
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card mb-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <h6 class="card-title col">Not Upload Health policies</h6>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive mt-2">
          <table id="not-uploaded-policy_tbl" class="table" data-name="health">
            <thead>
              <tr>
                <th>Policy Number</th>
                 <th>Inward No</th>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/reports/not-policy-pdf/health-pdf-policy.js') }}"></script>
