...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cancel SME Policy</li>
        </ol>
    </nav>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-2" style="width: auto">
                            <button class="btn btn-primary filter_sme_policy" id="filter_sme_policy">Filter SME
                                Policy</button>
                        </div>
                        <div class="col-2" style="width: auto">
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/reports/cancel-policy/sme-policy.js') }}"></script>
