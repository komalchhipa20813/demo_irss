...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cancel Motor Policy</li>
        </ol>
    </nav>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="motor_policy_searching_form" id="motor_policy_searching_form">
                        <div class="row">
                ...
                <input type="text" class="form-control" name="" id="sum_insured" value="" autocomplete="off" placeholder="Enter ">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-control select_dropdown" id="agent" name="agent"
                                        placeholder="Select agent">
                                        @if (!$data['agents']->isEmpty())
                                            <option selected disabled class="input-cstm" value="0">Please Select
                                            </option>
                                            @foreach ($data['agents'] as $agent)
                                                <option
                                                    @isset($policy->agent_id) @if ($policy->agent_id == $agent->id) selected @endif @endisset
                                                    value="{{ $agent->id }}">
                                                    {{ ucfirst($agent->code) . '-' . ucfirst($agent->prefix) . ' ' . ucfirst($agent->first_name) . ' ' . ucfirst($agent->last_name) }}
                                                </option>
                                            @endforeach
                                        @else
                                            <option selected disabled class="input-cstm" value="0">Please First Enter
                                                Agent</option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value=""
                                    autocomplete="off" placeholder="Enter Customer Name ">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select form-control " id="branch" name="branch"
                                    ...
                                    @if (!$data['irss_branches']->isEmpty())
                                        ...
                                        @foreach ($data['irss_branches'] as $branch)
                                            <option
                                                @isset($policy) @if ($policy->irss_branch_id == $branch->id) selected @endif @endisset
                                                value="{{ $branch->id }}">{{ ucfirst($branch->name) }}</option>
                                        @endforeach
                                    @else
                                        <option selected disabled class="input-cstm">Please First Enter Retinue Branch
                                        </option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="cheque_no" id="cheque_no" value=""
                                    autocomplete="off" placeholder="Enter Cheque Number">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="inward_no" class="control-label">Inward No</label>
                                <input type="text" class="form-control" name="inward_no" id="inward_no" value=""
                                    autocomplete="off" placeholder="Enter Inward No">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="policy_no" class="control-label">Policy No</label>
                                <input type="text" class="form-control" name="policy_no" id="policy_no"
                                    value="" autocomplete="off" placeholder="Enter Policy No">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="engine_no" class="control-label">Engine No</label>
                                <input type="text" class="form-control" name="engine_no" id="engine_no"
                                    value="" autocomplete="off" placeholder="Enter Engine No">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="chasis_no" class="control-label">Chasis No</label>
                                <input type="text" class="form-control" name="chasis_no" id="chasis_no"
                                    value="" autocomplete="off" placeholder="Enter Chasis No">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="registration_no" id="registration_no"
                                    value="" autocomplete="off" placeholder="Enter Registration No">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="product" class="  control-label">Product</label>
                                <select class="form-select form-control " id="product" name="product"
                                    placeholder="Select product">
                                    @if (!$data['products']->isEmpty())
                                        <option selected disabled class="input-cstm" value="0">Please Select</option>
                                        @foreach ($data['products'] as $product)
                                            <option
                                                @isset($policy) @if ($policy->product->id == $product->id) selected @endif @endisset
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control datepicker" name="policy_start_date"
                                    id="policy_start_date" value="" autocomplete="off"
                                    placeholder="Enter Policy Start Date">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="policy_end_date" class="control-label">Policy End Date</label>
                                <input type="text" class="form-control datepicker" name="policy_end_date"
                                    id="policy_end_date" value="" autocomplete="off"
                                    placeholder="Enter Policy End Date">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="from_date" class="control-label">From Date</label>
                                <input type="text" class="form-control datepicker" name="from_date" id="from_date"
                                    value="" autocomplete="off" placeholder="Enter From Date">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="end_date" class="control-label">End Date</label>
                                <input type="text" class="form-control datepicker" name="end_date" id="end_date"
                                    value="" autocomplete="off" placeholder="Enter End Date">
                            </div>
                        </div>
                    </form>
                    <div class="row">
                        <div class="col-2" style="width: auto">
                            <button class="btn btn-primary filter_motor_policy" id="filter_motor_policy">Filter Motor
                                Policy</button>
                        </div>
                        <div class="col-2" style="width: auto">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card mb-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h6 class="card-title col">Cancel Motor Policies</h6>

                        <div class="col-2 " style="width: auto">
                            <button type="button" id="export" style="float: right" class="btn btn-primary me-2s">
                                Export Motor Policy</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive mt-2">
                        <table id="cancel-policy_tbl" class="table">
                            <thead>
                                <tr>
                                    <th>Policy Number</th>
                                    ...
                                    <th>Inward No</th>
                                    <th>Company Name</th>
                                    <th>Policy Cancel Reason</th>
                                    <th>Policy Cancel Remark</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/reports/cancel-policy/motor-policy.js') }}"></script>
