...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cancel Health Policy</li>
        </ol>
    </nav>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="health_policy_searching_form" id="health_policy_searching_form">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-2" style="width: auto">
                            <button class="btn btn-primary filter_health_policy" id="filter_health_policy">Filter Health
                                Policy</button>
                        </div>
                        <div class="col-2" style="width: auto">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card mb-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h6 class="card-title col">Cancel Health Policies</h6>

                        <div class="col-2 " style="width: auto">
                            <button type="button" id="export" style="float: right" class="btn btn-primary me-2s">
                                Export Health Policy</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('assets/js/reports/cancel-policy/health-policy.js') }}"></script>
