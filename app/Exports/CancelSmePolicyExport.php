...
class CancelSmePolicyExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    ...
    {
        $request = [];
        $getPolicy = SmePolicy::where('status', 3)->with(['product', 'sub_product', 'customer', 'branch', 'company', 'companyBranch', 'branch_imd_name', 'payments']);
