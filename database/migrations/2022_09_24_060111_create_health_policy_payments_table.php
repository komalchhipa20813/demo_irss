...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('health_policy_payments', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('policy_id')->references('id')->on('health_policies');
    ...
    {
        Schema::dropIfExists('health_policy_payments');
    }
};
